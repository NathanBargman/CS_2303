...
/**
 * main function
 * @param int argc, the amount of arguments passed in the command line
 * @param char* argv[], the arguments passed in the command line. gridsize, #doodlebugs, #ants #time_steps seed pause
 */
